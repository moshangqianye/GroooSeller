...
public class UpdateAppManager {
	...
	private static final String FILE_PATH = Environment
			...
			+ FILE_SEPARATOR;
	// 下载应用存放全路径
	private static final String FILE_NAME = FILE_PATH + "GroooSeller.apk";
	// 更新应用版本标记
	...
	private String message = "检测到咕噜商家有新版本发布，建议您更新！不更新可能导致各种乱七八糟的问题。";
	...
	private void downloadApp() {
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					url = new URL(SellerApplication.updateDownload);
...
//		HttpUtils.getHttpClient().post(SellerApplication.updateDownload,
